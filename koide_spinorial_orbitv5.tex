...
After absorbing the normalisation factor $\sqrt{(1+\rho^2)/2}$
into $\mu$, the properly normalised background satisfies
$|a|^2 + |b|^2 = 1$ by construction, giving
\[
\int_0^{4\pi}|\partial_\phi\psi_{\rm cl}|^2\,d\phi
...
\begin{enumerate}[label=(\roman*)]
  ...
  \item The infrared RG fixed point of the effective Landau dynamics is $\rho = \sqrt{2}$,
        the unique equipartition point compatible with orbit coherence, giving $\Rightarrow \quad Q = \frac{2}{3}$.
\end{enumerate}
